...
void		 fu_plugin_add_rule			(FuPlugin	*plugin,
							 FuPluginRule	 rule,
							 const gchar	*name);
FuHwdb		*fu_plugin_get_hwdb			(FuPlugin	*plugin);
const gchar	*fu_plugin_lookup_hwdb_by_id		(FuPlugin	*plugin,
							 const gchar	*prefix,
							 const gchar	*id);
const gchar	*fu_plugin_lookup_hwdb_by_usb_device	(FuPlugin	*plugin,
							 const gchar	*prefix,
							 GUsbDevice	*dev);
